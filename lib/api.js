...
class Api {
  ...
  deliveryProgress(req, res, next) {
    const { country_retcode, station_id } = req.body;
    ...
    res.send({
      ...
      "data": {
        "list": new Array(50).fill(null).map(() => ({
          ...
          "max_last_7_days": -74026912354100
        }))
      }
    });
  }
  ...
  deliveryListExport(req, res, next) {
    const { country_retcode, station_id, address_id_list } = req.body;
  ...
  getUserList(req, res, next) {
    res.send({
      ...
      data: {
        pageno: 1,
        count: 10,
        total: wcs_user_list.length,
        list: wcs_user_list,
      },
    });
  }

  getUserLog(req, res, next) {
    res.send({
      retcode: 0,
      message: 'success',
      data: {
        pageno: 1,
        count: 10,
        total: wcs_user_log.length,
        list: wcs_user_log,
      },
    });
  }

  getUserLogDetail(req, res, next) {
    res.send({
      retcode: 0,
      message: 'success',
      data: wcs_user_log_detail,
    });
  }
  ...
  getRoleInfoByID(req, res, next) {
    res.send({
      retcode: 0,
      message: 'success',
      data: {
        ...wcs_role_list[0],
        permission_list: [330000],
      },
    });
  }

  getRoleLog(req, res, next) {
    res.send({
      retcode: 0,
      message: 'success',
      data: {
        pageno: 1,
        count: 10,
        total: wcs_role_log.length,
        list: wcs_role_log,
      },
    });
  }

  getRoleLogDetail(req, res, next) {
    res.send({
      retcode: 0,
      message: 'success',
      data: wcs_role_log_detail,
    });
  }
